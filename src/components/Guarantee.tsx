...
export default function Guarantee() {
  return (
    <section className="py-20 bg-gradient-to-br from-[#2E2A26] to-[#D2AB80]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-24 h-24 bg-white rounded-full mb-6 shadow-lg">
            <Shield className="w-12 h-12 text-[#C67A30]" />
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Garantia incontestável de <span className="text-[#C67A30]">7 dias</span>
          </h2>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-3 mb-4">
              <CheckCircle className="w-8 h-8 text-[#C67A30]" />
              <h3 className="text-2xl font-bold text-[#1A1A1A]">Satisfação 100% Garantida</h3>
            </div>
