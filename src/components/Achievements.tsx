      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-4">
            O que você vai conquistar com o <span className="text-[#C67A30]">Redação Prática</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {achievements.map((achievement, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow border-2 border-transparent hover:border-[#C67A30]"
            >
              <div className="bg-coffee-dark rounded-full w-14 h-14 flex items-center justify-center mb-4">
                <achievement.icon className="w-7 h-7 text-white" />
              </div>
              <p className="text-lg font-semibold text-[#1A1A1A]">{achievement.text}</p>
            </div>
          ))}
        </div>
        ...
        <div className="bg-coffee-dark rounded-3xl p-8 md:p-12">
          <h3 className="text-3xl font-bold text-white text-center mb-8">
            Redação Prática é sinônimo de <span className="text-[#C67A30]">bons resultados</span>
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-lg">
                <div className="text-5xl font-bold text-[#C67A30] mb-2">{student.score}</div>
                <p className="text-sm text-gray-500 mb-3">Nota ENEM</p>
                <p className="font-bold text-[#1A1A1A] mb-1">{student.name}</p>
          ...
          <div className="bg-white/10 backdrop-blur rounded-xl p-8">
            <h4 className="text-2xl font-bold text-white mb-6">
              Com o método de quem trabalhou nos <span className="text-[#C67A30]">bastidores da correção</span>, você leva:
            </h4>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-[#C67A30] flex-shrink-0" />
